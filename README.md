...
> **Unsigned builds** — your OS may warn on first launch:
>
> - **Windows** — *More info → Run anyway*.
> - **macOS** — right-click the app → *Open*. If macOS instead says it "is damaged and
>   can't be opened", that is just the download quarantine flag (not real damage); clear it:
>   ```bash
>   xattr -cr "BASS SEQ.app"     # or the .vst3 / .component you installed
>   ```
